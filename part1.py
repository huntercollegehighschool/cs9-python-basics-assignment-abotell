...
thirdv = int(input("Enter a third number: "))
fourthv = int(input("Enter a fourth number: "))
fifthv = int(input("Enter a fifth number: "))

print("The sum of the numbers you entered is", first_value + second_value + thirdv + fourthv + fifthv)